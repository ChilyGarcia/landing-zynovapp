...
const plans = [
  {
    ...
    features: ["Acceso a todas las funciones", "Límite de exámenes mensuales", "Soporte básico"],
    featured: false,
  },
  {
    name: "Professional",
    ...
    features: ["Exámenes ilimitados", "Soporte prioritario", "Reportes avanzados"],
    featured: true,
  },
  {
    name: "Enterprise IA",
    ...
    features: ["Exámenes ilimitados", "Módulo de análisis IA", "Consultas IA limitadas", "Soporte premium"],
    featured: false,
  },
];
    ...
    <section id="planes" className="py-24">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <p className="text-primary font-medium text-sm tracking-wider uppercase mb-4">Planes</p>
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">
            Selecciona el plan que mejor se adapte
          </h2>
          <p className="text-muted-foreground">Escala según las necesidades de tu laboratorio.</p>
        </div>
