      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          >
            ...
            <span className="text-sm text-primary font-medium">Plataforma con Inteligencia Artificial</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-gradient">exámenes de laboratorio clínico</span> con IA
          </motion.h1>
          ...
          >
            Plataforma web basada en Inteligencia Artificial que permite cargar, analizar y gestionar resultados de laboratorio clínico de manera rápida, segura y precisa.
          </motion.p>
          ...
          >
            <a href="#planes" className="bg-gradient-primary text-primary-foreground px-8 py-3.5 rounded-lg font-medium hover:opacity-90 transition-opacity flex items-center gap-2 shadow-glow">
              Ver Planes <ArrowRight size={18} />
            </a>
            <a href="#" className="flex items-center gap-3 px-8 py-3.5 rounded-lg border border-border hover:border-primary/50 transition-colors text-foreground">
        ...
        >
          <div className="relative rounded-xl overflow-hidden border border-border/50 shadow-card">
            ...
            <img src={heroDashboard} alt="Panel de Zynovapp" width={1280} height={800} className="w-full" />
          </div>
